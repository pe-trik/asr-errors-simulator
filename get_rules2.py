...
def main(args):
    ...
    with open(args.rules_output, 'w') as file:
        file.write(json.dumps(
                {CORPUS_INFO_WORD: {'p_insert':insertions / total, 'p_delete':deletions / total, 'p_transmit':(substitutions + no_error) / total, 'p_substitute':substitutions / (substitutions + no_error)}}, ensure_ascii=False
            ))
        file.write('\n')
